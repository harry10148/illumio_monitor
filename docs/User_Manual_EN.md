...
3. [CLI Interaction & Examples](#3-cli-interaction--examples)
4. [Web GUI Overview](#4-web-gui-overview)
5. [Rule Types & Filter Deep Dive](#5-rule-types--filter-deep-dive)
6. [System Settings & Alert Channels](#6-system-settings--alert-channels)
