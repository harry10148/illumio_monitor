...
MESSAGES = {
    "en": {
        ...
        "src_input": "Source Label/IP/IPList (e.g., role=Web or 10.0.0.1) [Press Enter to skip]",
        "dst_input": "Dest Label/IP/IPList (e.g., app=DB or 192.168.1.1) [Press Enter to skip]",
        ...
        "ex_src_input": "Exclude Source Label/IP/IPList (e.g., role=Scanner) [Press Enter to skip]",
        "ex_dst_input": "Exclude Dest Label/IP/IPList (e.g., 10.0.0.5) [Press Enter to skip]",
    ...
    "zh_TW": {
        ...
        "rule_overwritten": "規則已存在，已覆蓋更新設定。",
        ...
        "src_input": "來源標籤/IP/IPList (例如: role=Web 或 10.0.0.1) [按 Enter 跳過]",
        "dst_input": "目的標籤/IP/IPList (例如: app=DB 或 192.168.1.1) [按 Enter 跳過]",
        "trigger_threshold_count": "觸發閾值 (次數) [預設: 10]",
        "excludes_optional": "--- 排除條件 (Excludes) - 選填 ---",
        "ex_port_input": "排除 Port (例如: 22) [按 Enter 跳過]",
        "ex_src_input": "排除來源標籤/IP/IPList (例如: role=Scanner) [按 Enter 跳過]",
        "ex_dst_input": "排除目的標籤/IP/IPList (例如: 10.0.0.5) [按 Enter 跳過]",
